  ...
  return (
    <div className='vertical'>
      {jobOpenings.map(function(elem){
        return <Cards company={elem.companyName} date={elem.datePosted} work={elem.post} pay={elem.pay} location={elem.location} tag1={elem.tag1} tag2={elem.tag2} image={elem.brandLogo} />
      })}
